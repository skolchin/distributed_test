...
@click.command()
@click.option('-n', '--epochs', type=int, default=14, metavar='N',
                    help='number of epochs to train (default: 14)')
@click.option('--batch-size', type=int, default=64, metavar='N',
                    help='input batch size for training (default: 64)')
@click.option('--test-batch-size', type=int, default=1000, metavar='N',
                    help='input batch size for testing (default: 1000)')
@click.option('--lr', type=float, default=1.0, metavar='LR',
                    help='learning rate (default: 1.0)')
@click.option('--gamma', type=float, default=0.7, metavar='M',
